...
OPTION_CATALOG = (
    ...
    _spec("settings", "llm_primary_model", "string", "gemini-3.8-flash", "Primary LLM model.", env=("LLM_PRIMARY_MODEL", "GEMINI_MODEL")),
    ...
    _spec("settings", "llm_fallback_model", "string", "gpt-6-luna", "Fallback LLM model.", env=("LLM_FALLBACK_MODEL",)),
